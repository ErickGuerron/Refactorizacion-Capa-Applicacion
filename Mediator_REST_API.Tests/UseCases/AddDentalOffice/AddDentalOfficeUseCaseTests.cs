...
namespace Mediator_REST_API.Tests.UseCases.AddDentalOffice;

public class AddDentalOfficeUseCaseTests
{
    private readonly Mock<IDentalOfficeRepository> _repositoryMock;
    private readonly Mock<IUnitOfWork> _unitOfWorkMock;
    private readonly AddDentalOfficeUseCase _useCase;

    public AddDentalOfficeUseCaseTests()
    {
        _repositoryMock = new Mock<IDentalOfficeRepository>();
        _unitOfWorkMock = new Mock<IUnitOfWork>();
        _useCase = new AddDentalOfficeUseCase(
            _repositoryMock.Object,
            _unitOfWorkMock.Object,
            new AddDentalOfficeValidator());
    }

    [Fact]
    public async Task ExecuteAsync_WithValidInput_ReturnsOutputWithIdAndName()
    {
        var input = new AddDentalOfficeInput { Name = "Dental test" };
    ...
    {
        var input = new AddDentalOfficeInput { Name = "" };
    ...
    {
        var input = new AddDentalOfficeInput { Name = null! };
